...
// ⛳ Enlace con navegación SPA (no recarga, evita 404 del hosting)
function NavLnk({ to, children, style }) {
      ...
      <div className="dashboard-modules-grid">
        ...
        <div className="dashboard-module-card">
          ...
          <div className="dashboard-module-links">
            <NavLnk to={ROUTES.listadoFichas} style={linkStyle}>👥 Listado y Fichas</NavLnk>
            <NavLnk to={ROUTES.rrhhPermisos} style={linkStyle}>📝 Permisos y Justificaciones</NavLnk>
            <NavLnk to={ROUTES.rrhhValidacionDT} style={linkStyle}>✅ Validación DT</NavLnk>
            <NavLnk to={ROUTES.rrhhDocumentos} style={linkStyle}>📁 Repositorio Documental</NavLnk>
        ...
        <div className="dashboard-module-card">
          ...
          <div className="dashboard-module-links">
            <NavLnk to={ROUTES.asistenciaSupervision} style={linkStyle}>🔎👁️ Supervisión Integral</NavLnk>
            <NavLnk to={ROUTES.asistenciaMarcas} style={linkStyle}>🕒✅ Marcas Registradas</NavLnk>
            <NavLnk to={ROUTES.asistenciaMapa} style={linkStyle}>🗺️📍 Mapa de Cobertura</NavLnk>
            <NavLnk to={ROUTES.asistenciaGestionDispositivos || ROUTES.asistenciaDispositivos} style={linkStyle}>📟⚙️ Gestión de Dispositivos</NavLnk>
            <NavLnk to={ROUTES.asistenciaGestionTurnos || ROUTES.asistenciaTurnos} style={linkStyle}>📅🛠️ Gestión de Turnos y Jornadas</NavLnk>
          </div>
        </div>
