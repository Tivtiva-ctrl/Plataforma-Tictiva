...
// Volvemos a usar "Link" y añadimos "BrowserRouter" para solucionar el error
...
export default function Dashboard() {
  return (
    // Envolvemos todo en BrowserRouter para darle a los <Link> el contexto que necesitan
    <BrowserRouter>
