...
const Icon = ({ name, size = 24, className = "" }) => {
  ...
  switch (name) {
    ...
    case "map-pin": return (<svg {...p}><path d="M12 21s-6-4.35-6-10a6 6 0 1 1 12 0c0 5.65-6 10-6 10z"/><circle cx="12" cy="11" r="3"/></svg>);
    ...
    <div className="dash">
      ...
      <div className="grid">
        {MODULES.map((m, index) => (
          ...
          >
            {/* Abrir el DRAWER al clickear el header */}
            <header
            ...
            <footer className="card__foot">
              {/* Abrir el DRAWER desde “Abrir módulo →” */}
              <button
