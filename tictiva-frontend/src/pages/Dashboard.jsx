...
export default function Dashboard({ userName = "Verónica Mateo", onLogout }) {
  ...
  const SelectedIcon = selected ? (MODULE_ICONS[selected.key] || IconBars) : null;
  ...
  return (
    <div className="dashboardPage">
      ...
      {/* ===== Side panel SIN header (solo card + accesos + tip + botón cerrar) ===== */}
              ...
              <article className="panelModuleCard">
                ...
                {selected.key === "rrhh" ? (
                  <ul className="panelLinks panelLinks--plain">
                    ...
                    <li><span className="panelItemText">Permisos y justificaciones</span></li>
                    <li><span className="panelItemText">Gestión de turnos</span></li>
                    <li><span className="panelItemText">Validación DT</span></li>
                  </ul>
                ) : (
                  <ul className="panelLinks panelLinks--plain">
                    {(selected.items || []).map((it) => (
                      <li key={it}><span className="panelItemText">{it}</span></li>
                    ))}
                  </ul>
                )}
              </article>
